...
describe('Objects', () => {
  ...
  describe('Declatation', () => {
    ...
    it('should have inline object neasted', () => {
      ...
      return expect(promise).to.be.fulfilled
        .then(res => {
          expect(res).to.eq(`let foo = {a: 1, b: 2, c: {d: 2, e: {a: 1}, f: function (it?:any) {\n  return 1;\n}}};\n`);
        })
      ;
    });
...
`;
      ...
      return expect(promise).to.be.fulfilled
        .then(res => {
          expect(res).to.eq(`let foo = {a: 1, b: 'a', c: function (it?:any) {\n  return 1;\n}};\n`);
        })
      ;
    });
...
`;
      ...
      return expect(promise).to.be.fulfilled
        .then(res => {
          expect(res).to.eq(`a.b.c(1).e(function (it?:any) {
  return 1;
}).d('a', b).f(g(h));
`);
        })
