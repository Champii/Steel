...
var es2015Source = fs.readFileSync(path.join(path.dirname(require.resolve('typescript')), 'lib.es2015.d.ts')).toString();
var es7Source = fs.readFileSync(path.join(path.dirname(require.resolve('typescript')), 'lib.es2016.d.ts')).toString();
